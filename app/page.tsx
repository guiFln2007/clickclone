    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        @media(max-width:640px){.hero-mobile-logo{display:flex;justify-content:center;position:absolute;top:28px;left:0;right:0;z-index:5}.hero-mobile-logo img{height:90px;width:auto;filter:drop-shadow(0 0 22px rgba(255,140,0,.45))}}
